...
#define  APP_CFG_PROBE_OS_PLUGIN_EN      DEF_INACTIVE            /* DEF_ENABLED = Present, DEF_DISABLED = Not Present        */
#define  APP_CFG_PROBE_COM_EN            DEF_INACTIVE
#define  APP_CFG_LCD_EN                  DEF_INACTIVE
#define  APP_CFG_KSD_EN                  DEF_INACTIVE
